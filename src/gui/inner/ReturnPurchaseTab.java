 ...
 * @author Purnama
 */
public class ReturnPurchaseTab extends BasicInvoicePanel{
    
    ReturnPurchaseController returnpurchaseController;
    ItemInController itemController;
    WarehouseController warehouseController;
    
    ReturnPurchaseTableModel iptm;
    
    TableRowSorter<ReturnPurchaseTableModel> sorter;
    TableRowSorter<ItemInTableModel> sorter2;
    
    MyTextField filtertf;
    
    public ReturnPurchaseTab(){
        super();
        ...
        iptm = new ReturnPurchaseTableModel(returnpurchaseController.getReturnPurchaseList());
        
        maintable.setModel(iptm);
        
        sorter = new TableRowSorter<ReturnPurchaseTableModel>(iptm);
        ...
        addbutton.addActionListener((ActionEvent e) -> {
            ...
            JDialog dialog = pane.createDialog(null, "Retur Pembelian");
            dialog.show();
            ...
            try{
                if(pane.getValue() == null){
                    ...
                    if(quantity < 0){
                        JOptionPane.showMessageDialog(null, "Gagal menyimpan retur ~ jumlah barang tidak dapat kurang dari 0");
                    }
                    else{
                        boolean result = returnpurchaseController.addReturnPurchase(iptm, (Date)datePicker.getModel().getValue(),
                                GlobalFields.USER, quantity,
                                itemid, swarehouse, note.getText());
                        
                        if(result == GlobalFields.FAIL){
                            JOptionPane.showMessageDialog(null, "Gagal menyimpan retur ~ jumlah barang tidak mencukupi");
                        }
                    }
                }
            }
                ...
                JOptionPane.showMessageDialog(null, "Gagal menyimpan retur ~ tidak ada barang atau gudang yang dipilih");
            }
        });
        ...
        deletebutton.addActionListener((ActionEvent e) -> {
            try{
                ...
                if(jop.getValue() == null){
                    ...
                    boolean result = returnpurchaseController.deleteReturnPurchase(id);
        ...
        maintable.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ReturnPurchase returnpurchase = returnpurchaseController.getReturnPurchase(Integer.parseInt(maintable.getValueAt(maintable.getSelectedRow(), 0).toString()));
                
                Item_In item = returnpurchase.getItem();
                
                 if(returnpurchase.isStatus() == GlobalFields.CHECKED){
                ...
                notepanel.add(new JLabel(returnpurchase.getNote()));
                ...
                itempanel.add(new JLabel("Jumlah : " + (int)returnpurchase.getQuantity() + " karung"));
    ...
    private void newFilter() {
        RowFilter<ReturnPurchaseTableModel, Object> rf = null;
